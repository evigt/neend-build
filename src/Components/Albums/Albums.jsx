                    ...
                    _    <div id="nrow" className="row">
                        <div className="col-lg-2  col-2">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p id="albumText" class="card-text">Learn how to sleep better?</p>
                                </div>
                            </div>
                            </div>
                            <div className="col-lg-2  col-2">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p id="albumText" class="card-text">Rajisthan</p>
                                </div>
                            </div>
                            </div>
                            <div className="col-lg-2  col-2">
                            ...
                            <div className="SubscibeOption">
                               <a href="https://www.youtube.com/c/Neend1" target="_blank"> <img id="youtubeimg"style={{position:"absolute"}} src={youtube} /></a>
                                <div id="allign">
                                   <h1 className="Needlogo">Neend</h1>
                                   <p className="subscriber">9.0k subscriber</p>
                                </div>
                                </div>
                                <p id="para">For latest Stories and updates, subscribe to our Youtube Channel</p>
                                <a href="https://www.youtube.com/c/Neend1" target="_blank"><button id="btnstl"  >SUBSCRIBE NOW</button></a>
                                <br></br>
                                <br></br>
